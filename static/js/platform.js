...
(function() {
    var m = this || self,
        aa = function(a, b, c) { return a.call.apply(a.bind, arguments) },
        ba = function(a, b, c) {
            if (!a) throw Error();
        ...
        ca = function(a, b, c) { ca = Function.prototype.bind && -1 != Function.prototype.bind.toString().indexOf("native code") ? aa : ba; return ca.apply(null, arguments) },
        da = function(a,
            b) {
            function c() {}
            ...
            a.A = function(d, e, f) { for (var g = Array(arguments.length - 2), h = 2; h < arguments.length; h++) g[h - 2] = arguments[h]; return b.prototype[e].apply(d, g) }
        };
    var ea = function() { this.V = "" };
    ea.prototype.toString = function() { return "SafeScript{" + this.V + "}" };
    ea.prototype.i = function(a) { this.V = a };
    (new ea).i("");
    var fa = function() { this.X = "" };
    fa.prototype.toString = function() { return "SafeStyle{" + this.X + "}" };
    fa.prototype.i = function(a) { this.X = a };
    (new fa).i("");
    var ha = function() { this.W = "" };
    ha.prototype.toString = function() { return "SafeStyleSheet{" + this.W + "}" };
    ha.prototype.i = function(a) { this.W = a };
    (new ha).i("");
    var q = function() { this.U = "" };
    q.prototype.toString = function() { return "SafeHtml{" + this.U + "}" };
    q.prototype.i = function(a) { this.U = a };
    ...
    var t = window,
        ...
        ja = function() {},
        ka = /\[native code\]/,
        w = function(a, b, c) { return a[b] = a[b] || c },
        la = function(a) {
        ...
        ra = /"/g,
        sa = /'/g,
        ta = function(a) { return String(a).replace(na, "&amp;").replace(oa, "&lt;").replace(pa, "&gt;").replace(ra, "&quot;").replace(sa, "&#39;") },
        x = function() {
            var a;
            if ((a = Object.create) &&
                ka.test(a)) a = a(null);
        ...
        z = function(a, b) { return Object.prototype.hasOwnProperty.call(a, b) },
        ua = function(a) {
        ...
        A = function(a, b) { a = a || {}; for (var c in a) z(a, c) && (b[c] = a[c]) },
        va = function(a) { return function() { t.setTimeout(a, 0) } },
    ...
    var D = function(a, b, c) {
        ...
        F = function(a) {
            a = String(a);
            a = a.replace(xa, function(e) { try { return encodeURIComponent(e) } catch (f) { return encodeURIComponent(e.replace(/^[^%]+$/g, "\ufffd")) } }).replace(ya, function(e) { return e.replace(/%/g, "%25") }).replace(za, function(e) { return e.toUpperCase() });
            a = a.match(wa) || [];
            var b = x(),
                c = function(e) {
        ...
        Ba = function(a) { return a.A + (0 < a.query.length ? "?" + a.query.join("&") : "") + (0 < a.g.length ? "#" + a.g.join("&") : "") },
        Ca = function(a, b) {
            var c = [];
            if (a)
                for (var d in a)
    ...
    var Ha = function(a, b, c, d) {
        ...
        Ja = function() { var a = v.readyState; return "complete" === a || "interactive" === a && -1 == navigator.userAgent.indexOf("MSIE") },
        Ma = function(a) {
            var b = Ka;
            if (!Ja()) try { b() } catch (c) {}
            La(a)
        ...
        La = function(a) {
            if (Ja()) a();
                ...
                t.addEventListener ? (t.addEventListener("load", c, !1), t.addEventListener("DOMContentLoaded", c, !1)) : t.attachEvent &&
                    (t.attachEvent("onreadystatechange", function() { Ja() && c.apply(this, arguments) }), t.attachEvent("onload", c))
            }
        },
        Na = function(a) { for (; a.firstChild;) a.removeChild(a.firstChild) },
        Oa = { button: !0, div: !0, span: !0 };
    var G;
    G = w(t, "___jsl", x());
    w(G, "I", 0);
    w(G, "hel", 10);
    var Pa = function(a) { return G.dpo ? G.h : D(a, "jsh", G.h) },
        Qa = function(a) {
            var b = w(G, "sws", []);
            b.push.apply(b, a)
        },
        Ra = function(a) { return w(G, "watt", x())[a] },
        Sa = function(a) {
            var b = w(G, "PQ", []);
            G.PQ = [];
            var c = b.length;
        ...
        Ta = function(a) { return w(w(G, "H", x()), a, x()) };
    var Ua = w(G, "perf", x()),
        Va = w(Ua, "g", x()),
        Wa = w(Ua, "i", x());
    w(Ua, "r", []);
    x();
    x();
    var Xa = function(a, b, c) { var d = Ua.r; "function" === typeof d ? d(a, b, c) : d.push([a, b, c]) },
        H = function(a, b, c) {
            Va[a] = !b && Va[a] || c || (new Date).getTime();
            Xa(a)
        },
        Za = function(a, b, c) { b && 0 < b.length && (b = Ya(b), c && 0 < c.length && (b += "___" + Ya(c)), 28 < b.length && (b = b.substr(0, 28) + (b.length - 28)), c = b, b = w(Wa, "_p", x()), w(b, c, x())[a] = (new Date).getTime(), Xa(a, "_p", c)) },
        Ya = function(a) { return a.join("__").replace(/\./g, "_").replace(/\-/g, "_").replace(/,/g, "_") };
    var $a = x(),
        J = [],
        L = function(a) { throw Error("Bad hint" + (a ? ": " + a : "")); };
    J.push(["jsl", function(a) {
        for (var b in a)
            if (z(a, b)) { var c = a[b]; "object" == typeof c ? G[b] = w(G, b, []).concat(c) : w(G, b, c) }
    ...
    var ab = /^(\/[a-zA-Z0-9_\-]+)+$/,
        ...
        jb = function(a) {
            ...
            e = mb(a, "rs");
            a = mb(a, "t");
            return { pathPrefix: b, version: c, M: d, Y: e, $: a }
        },
        kb = function(a) {
        ...
        gb = /\/cb=/g,
        fb = /\/\//g,
        nb = function() { var a = Pa(ia.href); if (!a) throw Error("Bad hint"); return a };
    ...
    var ob = decodeURI("%73cript"),
        ...
        rb = function() { var a = G.nonce; return void 0 !== a ? a && a === String(a) && a.match(pb) ? a : G.nonce = null : v.querySelector ? (a = v.querySelector("script[nonce]")) ? (a = a.nonce || a.getAttribute("nonce") || "", a && a === String(a) && a.match(pb) ? G.nonce = a : G.nonce = null) : null : null },
        tb = function(a) {
            ...
            if (e["::"] && b.length) {
                ...
                for (var f = null; f = b.shift();) {
                    ...
                    var h = a.length && a[a.length - 1] || null,
                        k = h;
                    h && h.hint == g || (k = { hint: g, P: [] }, a.push(k));
                    k.P.push(f)
                }
                var l = a.length;
                if (1 < l) {
        ...
        xb = function(a, b,
            ...
            var p = w(Ta(c), "L", []).sort(),
                ...
                u = function(K, Y) {
                    ...
                    if (Y) { Za("me0", K, r); try { wb(Y, c, k) } finally { Za("me1", K, r) } }
                    return 1
                };
            ...
            if (y.length) {
                ...
                E[I] = function(K) {
                    ...
                    0 < I && E[I - 1] ? E[I] = function() { Y(Z) } : Y(Z)
                };
                if (y.length) {
                    var Ia = "loaded_" + G.I++;
                    C[Ia] = function(K) {
    ...
    var vb = function(a, b) { if (G.hee && 0 < G.hel) try { return a() } catch (c) { b && b(c), G.hel--, M("debug_error", function() { try { window.___jsl.hefn(c) } catch (d) { throw c; } }) } else try { return a() } catch (c) { throw b && b(c), c; } };
    C.load = function(a, b) { return vb(function() { return M(a, b) }) };
    var yb = function(a) {
        ...
        Ab = function(a) { return "object" === typeof a && /\[native code\]/.test(a.push) },
        N = function(a, b, c) {
        ...
        Bb = function(a) { if (a && !/^\s+$/.test(a)) { for (; 0 == a.charCodeAt(a.length - 1);) a = a.substring(0, a.length - 1); try { var b = window.JSON.parse(a) } catch (c) {} if ("object" === typeof b) return b; try { b = (new Function("return (" + a + "\n)"))() } catch (c) {} if ("object" === typeof b) return b; try { b = (new Function("return ({" + a + "\n})"))() } catch (c) {} return "object" === typeof b ? b : {} } },
        Cb = function(a, b) {
            var c = { ___goc: void 0 };
    ...
    var Gb = { callback: 1, clientid: 1, cookiepolicy: 1, openidrealm: -1, includegrantedscopes: -1, requestvisibleactions: 1, scope: 1 },
        Hb = !1,
        Ib = x(),
        Jb = function() {
            if (!Hb) {
                ...
                if (window.self !== window.top) { a = document.location.toString(); for (var e in Gb) 0 < Gb[e] && (b = D(a, e, "")) && (Ib[e] = b) }
                Hb = !0
            }
            e = x();
            A(Ib, e);
    ...
    var Lb = window.console,
        Mb = function(a) { Lb && Lb.log && Lb.log(a) };
    var Nb = function() { return !!G.oa },
        Ob = function() {};
    var P = w(G, "rw", x()),
        Pb = function(a) { for (var b in P) a(P[b]) },
        Qb = function(a, b) {
    ...
    var Wb, Q, R = void 0,
        S = function(a) { try { return m.JSON.parse.call(m.JSON, a) } catch (b) { return !1 } },
        T = function(a) { return Object.prototype.toString.call(a) },
        Xb = T(0),
        Yb = T(new Date(0)),
        Zb = T(!0),
        $b = T(""),
        ...
        tc = function(a) {
            ...
            a = a.replace(rc, "\\u2028").replace(sc,
                "\\u2029");
            b = void 0;
            try { b = R ? [S(a)] : eval("(function (var_args) {\n  return Array.prototype.slice.call(arguments, 0);\n})(\n" + a + "\n)") } catch (c) { return !1 }
        ...
        uc = function() {
            ...
            if ((void 0 === Wb || void 0 === R || Q !== a) && -1 !== Q) {
                ...
                Q = -1;
                try {
                    try { R = !!m.JSON && '{"a":[3,true,"1970-01-01T00:00:00.000Z"]}' === m.JSON.stringify.call(m.JSON, { a: [3, !0, new Date(0)], c: function() {} }) && !0 === S("true") && 3 === S('[{"a":3}]')[0].a } catch (b) {}
                    Wb = R && !S("[00]") &&
                        !S('"\u0007"') && !S('"\\0"') && !S('"\\v"')
                } finally { Q = a }
            }
        ...
        wc = function(a) { if (-1 !== Q) return uc(), R ? m.JSON.stringify.call(m.JSON, a) : U(a) },
    ...
    var Cc = function() { this.K = new Ac };
    Cc.prototype.reset = function() { this.K.reset() };
    var Dc = t.crypto,
        Ec = !1,
        Fc = 0,
        Gc = 0,
    ...
    var Oc = function() {
        ...
        Pc = function(a, b) { b = b.onload; return "function" === typeof b ? (Oc().a(a, b), b) : null },
        Qc = function(a) {
            B(/^\w+$/.test(a), "Unsupported id - " + a);
            Oc();
            return 'onload="window.___jsl.onl.e(&#34;' + a + '&#34;)"'
        },
        Rc = function(a) { Oc().r(a) };
    var Sc = { allowtransparency: "true", frameborder: "0", hspace: "0", marginheight: "0", marginwidth: "0", scrolling: "no", style: "", tabindex: "0", vspace: "0", width: "100%" },
        Tc = { allowtransparency: !0, onload: !0 },
        Uc = 0,
        Vc = function(a) { B(!a || Ga.test(a), "Illegal url for new iframe - " + a) },
        Wc = function(a, b, c, d, e) {
            Vc(c.src);
            var f, g = Pc(d, c),
                h = g ? Qc(d) : "";
            try { document.all && (f = a.createElement('<iframe frameborder="' + ta(String(c.frameborder)) + '" scrolling="' + ta(String(c.scrolling)) + '" ' + h + ' name="' + ta(String(c.name)) + '"/>')) } catch (l) {} finally {
                f ||
    ...
    var Xc = /^:[\w]+$/,
        ...
        Zc = function() {
            ...
            return Rb = { socialhost: f, ctx_socialhost: d ? g : f, session_index: a, session_delegate: b, session_prefix: c, im_prefix: e }
        },
        $c = function(a, b) { return Zc()[b] || "" },
        ad = function(a) {
            return function(b,
                c) { return a ? Zc()[c] || a[c] || "" : Zc()[c] || "" }
        };
    var bd = function(a) {
            var b;
    ...
    var dd = { se: "0" },
        ed = { post: !0 },
        fd = { style: "position:absolute;top:-10000px;width:450px;margin:0px;border-style:none" },
        ...
        kd = function(a) { var b = void 0; "number" === typeof a ? b = a : "string" === typeof a && (b = parseInt(a, 10)); return b },
        nd = function() {
            var a = G.drw;
            Pb(function(b) {
    ...
    var od, pd, V, qd, rd, sd = /(?:^|\s)g-((\S)*)(?:$|\s)/,
        td = { plusone: !0, autocomplete: !0, profile: !0, signin: !0, signin2: !0 };
    od = w(G, "SW", x());
    pd = w(G, "SA", x());
    V = w(G, "SM", x());
    qd = w(G, "FW", []);
    ...
    var vd = function(a, b) { ud(void 0, !1, a, b) },
        ud = function(a, b, c, d) {
            ...
            H("ps1", !0);
            if ((r = qd.join(":")) || a) try { C.load(r, a) } catch (E) { Mb(E); return }
            if (wd(rd || {}))
                for (var y in c) {
                    a =
                        c[y];
        ...
        Ad = function(a) {
            var b = w(C, a, {});
            b.go || (b.go = function(c) { return vd(c, a) }, b.render = function(c, d) {
                d = d || {};
                d.type = a;
                return md(c, d)
            })
        },
        Bd = function(a) { od[a] = !0 },
        Cd = function(a) { pd[a] = !0 },
        Dd = function(a) { V[a] = !0 };
    var xd = function(a, b) {
            var c = Ra(a);
                ...
                case 1:
                    if (b.parentNode) {
                        for (var h in c) {
                            ...
                            if (f) try { c[h] = wc(c[h]) } catch (y) { delete c[h] }
                        }
                        f = !0;
                        c.dontclear && (f = !1);
                        delete c.dontclear;
        ...
        Ed = function(a, b, c) {
            if (a && 1 === a.nodeType && b) {
                ...
                } else { if (pd[b]) return 0; if (od[b]) return 1 }
            }
            return null
        },
        md = function(a, b) {
    ...
    var Ka = function(a) { ud(a, !0) },
        Gd = function(a, b) { b = b || []; for (var c = 0; c < b.length; ++c) a(b[c]); for (a = 0; a < b.length; a++) Ad(b[a]) };
    ...
    var Id = /^\{h:'/,
        ...
        Kd = "",
        Fd = function(a, b) {
            function c() { Ha("message", d, "remove", "de") }
            ...
            function d(f) {
                ...
                if (Ld(g, b)) {
                    ...
                    Md(a, function() {
                        k && H("rqd");
                        c();
                        for (var l = w(G, "RPMQ", []), n = 0; n < l.length; n++) l[n]({ data: g, origin: h })
                    })
                }
            }
            if (0 !== b.length) {
    ...
    Nd.prototype.read = function() { for (var a = this.J + "=", b = document.cookie.split(/;\s*/), c = 0; c < b.length; ++c) { var d = b[c]; if (0 == d.indexOf(a)) return d.substr(a.length) } };
    ...
    Nd.prototype.clear = function() { this.write("", 0) };
    ...
    var Qd = function(a) { this.B = a },
        W = {};
    Qd.prototype.read = function() { if (W.hasOwnProperty(this.B)) return W[this.B] };
    Qd.prototype.write = function(a) { W[this.B] = a; return !0 };
    Qd.prototype.clear = function() { delete W[this.B] };
    Qd.iterate = function(a) { for (var b in W) W.hasOwnProperty(b) && a(b, W[b]) };
    var Rd = "https:" === window.location.protocol,
        ...
        Ud = function() {
            var a, b = null;
            Sd.iterate(function(c, d) { 0 === c.indexOf("G_AUTHUSER_") && (c = Td(c.substring(11)), !a || c.j && !a.j || c.j == a.j && c.o > a.o) && (a = c, b = d) });
            return { ba: a, F: b }
        };
    var Vd = function(a) {
            ...
            d = "E" === c && e.j;
            return !d && ("U" !== c || e.j) || d && !Rd ? b : { R: !0, j: d, ga: a.substr(1), domain: e.domain, o: e.o }
        },
        Wd = function(a) {
            if (!a) return [];
            a = a.split("=");
            ...
            if (null !== a) {
                ...
                if (c) {
                    var d = Xd(c),
                        e = d && d.fa[Number(a)];
                    d = d && d.clientId;
                    if (e) return { F: a, ea: e, clientId: d }
                }
            }
            return null
        };
    var X = function() { this.N = Zd };
    X.prototype.w = 0;
    X.prototype.L = 2;
    X.prototype.N = null;
    X.prototype.H = !1;
    X.prototype.Z = function() { this.H || (this.w = 0, this.H = !0, this.T()) };
    X.prototype.T = function() { this.H && (this.N() ? this.w = this.L : this.w = Math.min(2 * (this.w || this.L), 120), window.setTimeout(ca(this.T, this), 1E3 * this.w)) };
    for (var $d = 0; 64 > $d; ++$d);
    var ae = null;
    Nb = function() { return G.oa = !0 };
    Ob = function() {
        G.oa = !0;
        var a = Yd();
