...
! function(t, i) {
        ...
        Le = ui.extend({
            ...
            panBy: function(t, i) {
                ...
                if (this._panAnim || (this._panAnim = new we,
                    ...
                    i.noMoveStart || this.fire("movestart"), !1 !== i.animate) {
    ...
    var Se, Ee = {
        ...
        Be = ui.extend({
            ...
            _onDown: function(t) {
                if (!t._simulated && this._enabled && (this._moved = !1, !dt(this._element, "leaflet-zoom-anim") && !(Be._dragging || t.shiftKey || 1 !== t.which && 1 !== t.button && !t.touches || (Be._dragging = this,
...
L.Polyline.plotter = L.Polyline.extend({
    ...
    _onMapClick(a) {
        //点击事件绑定，是否已经点击创建路径，是，点击生效-》创建标记点
    ...
    _redrawHalfwayPoints() {
        //清空原因 ，点击中间点，会将该中间点转为点击点，自动二边扩展为二个中间点，，中间点数组绑定，一次划线线条---直线
        ...
        for (index in this._lineMarkers) {
            ...
            //总共两个数组，一个是原始点击点数组_lineMarkers
            //一个是自动生成的中间点数组  _halfwayPointMarkers，
