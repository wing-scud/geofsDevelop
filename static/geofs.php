<!DOCTYPE HTML>
<html lang="en"><script>window.geofs = window.geofs || {};</script>
<script>geofs.version = '2.7';</script>
<script>geofs.multiplayerHost = 'https://net.geo-fs.com:8080';</script>
<script>geofs.domain = 'www.geo-fs.com';</script>
<script>geofs.userRoles = {"anonymous":0,"authenticated":1,"editor":11,"subscribed":21,"admin":100};</script>
...
<script>geofs.dataServer = 'https://data3.geo-fs.com/';</script>
...
<script>geofs.mapXYZ = 'https://data3.geo-fs.com/osm/{z}/{x}/{y}.png';</script>
<script>geofs.ionkey = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiIwYjk1N2FhZi1hN2M5LTQ4ZmUtOWVhMS0yNDVjODBmODlmOGQiLCJpZCI6NzYsImlhdCI6MTQ4ODIxMDc4OX0.Sv58Vigu_z-rEXj1SyO1ygvo4LhA6bDPyKIjsQ3Bgc4';</script>
<head><title>GeoFS - Free Multiplayer Flight Simulator</title><link rel="canonical" href="https://www.geo-fs.com/geofs.php"><meta http-equiv="X-UA-Compatible" content="IE=edge"><meta http-equiv="content-type" content="text/html; charset=utf-8"><meta name="keywords" content="flight simulator, game, free, online, multiplayer, simulation, joystick, aviation, helicopter, hot air balloon, aircraft, pilot"><meta name="description" content="Free multiplayer flight simulator with worldwide satellite images. GeoFS runs in your web browser: nothing to install."><meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, minimum-scale=1, user-scalable=no"><meta name="apple-mobile-web-app-capable" content="yes"><meta name="apple-mobile-web-app-status-bar-style" content="black-translucent"><link rel="apple-touch-icon-precomposed" href="apple-touch-icon.png"><link rel="shortcut icon" href="favicon.ico"><script type="text/javascript" src="js/loader.js" dest="js/loader.js" obfuscation="update"></script><!-- Common CSS --><link rel="stylesheet" type="text/css" href="/css/commonCSS.css?kc=1566290741-3" media="screen"/><!-- Common JS --><deferredscript type="text/javascript" src="/js/commonJS.js?kc=1566290741-3"></deferredscript><!-- 3rd parties --><deferredscript type="text/javascript" src="js/Cesium/1-61/Cesium.js" defer></deferredscript><script defer type="text/javascript" src="https://www.google-analytics.com/ga.js" obfuscation="none"></script><!-- Common libs --><!-- Sim --><!-- Data --><script type="text/javascript">geofs.PRODUCTION = true;geofs.killCache = '?kc=1568294263';</script><deferredscript type="text/javascript" src="/js/geofs.js?kc=1568294262-13" defer></deferredscript><link rel="stylesheet" type="text/css" href="css/geofs.css?kc=1568294262" media="screen"/></head><body class="geofs geofs-ingame legacyAutopilot" style="overflow: hidden;">
...
</ul><ul class="geofs-list geofs-toggle-panel geofs-preference-list geofs-preferences"
    data-noblur="true"
    ...
    <li class="geofs-list-collapsible-item geofs-preference-controls">Controls
        ...
        <ul class="geofs-list">
            <!-- Controls -->
            <legend>Select a control device and configure it.</legend>
            ...
            <li class="no-hover geofs-list-collapsible-item geofs-hideForApp">
                <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect geofs-stopMousePropagation geofs-expendable-radio" for="control-keyboard">
                    ...
                    <input type="radio" id="control-keyboard" class="mdl-radio__button" name="control"
                           update="{controls.setMode(value)}"
                           gespref="geofs.preferences.controlMode"
                           matchvalue="keyboard"/>
                ...
                <div class="geofs-collapsible">
                    ...
                    <fieldset>
                        ...
                        <label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="keyboardMixYawRoll" title="Mixes the rudder with the ailerons input">
                            <input type="checkbox" id="keyboardMixYawRoll" class="mdl-switch__input" gespref="geofs.preferences.keyboard.mixYawRoll" update="{controls.setMode()}">
                            <span class="mdl-switch__label">Mix Roll/Yaw</span>
                        </label>

                        <div title="Sets how much rudder is mixed from the ailerons input" class="slider"
                             type="slider" gespref="geofs.preferences.keyboard.mixYawRollQuantity"
                        ...
                        <div title="Sets how quickly the input responds" class="slider" type="slider"
                             gespref="geofs.preferences.keyboard.sensitivity" update="{controls.setMode()}" value="0"
                        ...
                        <!--
                        <br/>Exponential: <div type="slider" max="2" step="0.1" class="geofs-ui-slider" gespref="geofs.preferences.keyboard.exponential" ></div>
                        -->
                    </fieldset>
                    <fieldset>
                        <legend>
                ...
                <div class="geofs-collapsible">
                    <fieldset>
                        ...
                        <label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="mouseMixYawRoll" title="Mixes the rudder with the ailerons input">
                            <input type="checkbox" id="mouseMixYawRoll" class="mdl-switch__input" gespref="geofs.preferences.mouse.mixYawRoll" update="{controls.setMode()}">
                            <span class="mdl-switch__label">Mix Roll/Yaw</span>
                        </label>

                        <div title="Sets how much rudder is mixed from the ailerons input" class="slider"
                             type="slider" gespref="geofs.preferences.mouse.mixYawRollQuantity"
                             update="{controls.setMode()}" value="0" min="0.1" max="4" precision="1">
                            <div class="slider-rail">
                                <div class="slider-selection">
                                    <div class="slider-grippy">
                        ...
                        <div title="Sets how quickly the input responds" class="slider" type="slider"
                             gespref="geofs.preferences.mouse.sensitivity" update="{controls.setMode()}" value="0"
                        ...
                        <div title="For hight value, input will be gentle near the center and fast at the extremes"
                             class="slider" type="slider" gespref="geofs.preferences.mouse.exponential"
            ...
            <li class="no-hover geofs-list-collapsible-item">
                <label class="mdl-radio mdl-js-radio mdl-js-ripple-effect geofs-stopMousePropagation geofs-expendable-radio" for="control-joystick">
                    <input type="radio" id="control-joystick" class="mdl-radio__button" name="control"
                           ...
                           gespref="geofs.preferences.controlMode"
                           matchvalue="joystick"/>
                    <span class="mdl-radio__label">Joystick [J]
                    </span>
                </label>
                configure
                <div class="geofs-collapsible geofs-preferences-joystick">
                    ...
                    <fieldset>
                        ...
                        <label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="joystickMixYawRoll" title="Mixes the rudder with the ailerons input">
                            <input type="checkbox" id="joystickMixYawRoll" class="mdl-switch__input" gespref="geofs.preferences.joystick.mixYawRoll" update="{controls.setMode()}">
                            <span class="mdl-switch__label">Mix Roll/Yaw</span>
                        </label>

                        <div title="Sets how much rudder is mixed from the ailerons input" class="slider"
                             type="slider" gespref="geofs.preferences.joystick.mixYawRollQuantity"
                             update="{controls.setMode()}" value="0" min="0.1" max="4" precision="1">
                            <div class="slider-rail">
                                <div class="slider-selection">
                                    <div class="slider-grippy">
                        ...
                        <div title="Sets how quickly the input responds" class="slider" type="slider"
                             gespref="geofs.preferences.joystick.sensitivity" update="{controls.setMode()}" value="0"
                             min="0.1" max="2" precision="1">
                            <div class="slider-rail">
                                <div class="slider-selection">
                                    <div class="slider-grippy">
                        ...
                        <div title="For hight value, input will be gentle near the center and fast at the extremes"
                             class="slider" type="slider" gespref="geofs.preferences.joystick.exponential"
                             update="{controls.setMode()}" value="0" min="0.1" max="2" precision="1">
                            <div class="slider-rail">
                                <div class="slider-selection">
                                    <div class="slider-grippy">
            ...
            <li class="no-hover geofs-list-collapsible-item geofs-preferences-orientation geofs-onlyForApp">
                ...
                <div class="geofs-collapsible">
                    ...
                    <div class="geofs-preferences-orientation-status">
                        <div class="alert alert-error">
                    ...
                    <fieldset>
                        ...
                        <label class="checkbox" title="Mixes the rudder with the ailerons input">
                            <input type="checkbox" gespref="geofs.preferences.orientation.mixYawRoll"
                                   update="{controls.setMode()}"/>
                            Mix Roll/Yaw </label>

                        <div title="Sets how much rudder is mixed from the ailerons input" class="slider"
                             type="slider" gespref="geofs.preferences.orientation.mixYawRollQuantity"
                             update="{controls.setMode()}" value="0" min="0.1" max="4" precision="1">
                            <div class="slider-rail">
                                <div class="slider-selection">
                                    <div class="slider-grippy">
                        ...
                        <div title="Sets how quickly the input responds" class="slider" type="slider"
                             gespref="geofs.preferences.orientation.sensitivity" update="{controls.setMode()}" value="0"
                             min="0.1" max="2" precision="1">
                            <div class="slider-rail">
                                <div class="slider-selection">
                                    <div class="slider-grippy">
                        ...
                        <div title="For hight value, input will be gentle near the center and fast at the extremes"
                             class="slider" type="slider" gespref="geofs.preferences.orientation.exponential"
                             update="{controls.setMode()}" value="0" min="0.1" max="2" precision="1">
                            <div class="slider-rail">
                                <div class="slider-selection">
                                    <div class="slider-grippy">
                    ...
                    <fieldset style="float: left;">
                        ...
                        <div class="geofs-feedback-wrapper">
                            <label>Pitch</label>
                            <select gespref="geofs.preferences.orientation.axis.pitch">
                            ...
                            <label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="reverseOrientationPitch" title="Inverse axis">
                                <input type="checkbox" id="reverseOrientationPitch" class="mdl-switch__input" gespref="geofs.preferences.orientation.multiplier.pitch" update="{controls.setMode()}">
                        ...
                        <div class="geofs-feedback-wrapper">
                            <label>Roll</label>
                            <select gespref="geofs.preferences.orientation.axis.roll">
                                <option value="none">None</option>
                                <option value="0">Axis 0</option>
                                <option value="1">Axis 1</option>
                            </select>
                            ...
                            <label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="reverseOrientationRoll" title="Inverse axis">
                                <input type="checkbox" id="reverseOrientationRoll" class="mdl-switch__input" gespref="geofs.preferences.orientation.multiplier.roll" update="{controls.setMode()}">
                                <span class="mdl-switch__label">Inverse</span>
                            </label>
            ...
            <li class="no-hover geofs-list-collapsible-item geofs-preferences-touch geofs-onlyForApp">
                ...
                <div class="geofs-collapsible">
                    ...
                    <fieldset>
                        ...
                        <label class="checkbox" title="Mixes the rudder with the ailerons input">
                            <input type="checkbox" gespref="geofs.preferences.touch.mixYawRoll"
                                   update="{controls.setMode()}"/>
                            Mix Roll/Yaw </label>

                        <div title="Sets how much rudder is mixed from the ailerons input" class="slider"
                             type="slider" gespref="geofs.preferences.touch.mixYawRollQuantity"
                             update="{controls.setMode()}" value="0" min="0.1" max="4" precision="1">
                            <div class="slider-rail">
                                <div class="slider-selection">
                                    <div class="slider-grippy">
                        ...
                        <div title="Sets how quickly the input responds" class="slider" type="slider"
                             gespref="geofs.preferences.touch.sensitivity" update="{controls.setMode()}" value="0"
                        ...
                        <div title="For hight value, input will be gentle near the center and fast at the extremes"
                             class="slider" type="slider" gespref="geofs.preferences.touch.exponential"
                             update="{controls.setMode()}" value="0" min="1" max="3" precision="1">
                            <div class="slider-rail">
                                <div class="slider-selection">
                                    <div class="slider-grippy">
                                        <input class="slider-input"/>
    ...
    <li class="geofs-list-collapsible-item geofs-hideForApp">Simulation
        ...
        <div class="geofs-collapsible">
            ...
            <fieldset>
                ...
                <label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="crashDetection" title="Enable crash detection">
                    <input type="checkbox" id="crashDetection" class="mdl-switch__input" gespref="geofs.preferences.crashDetection">
        ...
        <div class="geofs-collapsible">
            ...
            <fieldset>
                ...
                <label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="enableMultiplayer" title="Enable multiplayer">
                    <input type="checkbox" id="enableMultiplayer" class="mdl-switch__input" gespref="geofs.preferences.multiplayer"
                ...
                <label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="enableADSB" title="Enable ADS-B Traffic">
                    <input type="checkbox" id="enableADSB" class="mdl-switch__input" gespref="geofs.preferences.adsb" />
                ...
                <label class="mdl-switch mdl-js-switch mdl-js-ripple-effect geofs-hideForApp" for="enableChat" title="Enable text chat">
                    <input type="checkbox" id="enableChat" class="mdl-switch__input geofs-enabledWhenAuthenticated" gespref="geofs.preferences.chat" update="{if (!this.checked) {ui.chat.hide();}}" />
                    <span class="mdl-switch__label">Enable text chat</span>
                </label>
                <i class="geofs-loggedout geofs-hideForApp">You must be logged in to use the chat<br/></i>
                <i class="geofs-hideForApp">Note: the chat is self moderated: please stay courteous.<br/>
                    If you may be offended by strong language, leave the chat off.</i>
            </fieldset>
        ...
        <div class="geofs-collapsible">
            ...
            <fieldset>
                <legend class="geofs-hideForApp">
                    Performance vs. Quality - Anything above 3 requires a fast computer and may slow down the simulation considerably
                </legend>
                <legend class="geofs-onlyForApp">
                    Performance vs. Quality - (resolution, viewing distance, amount of clouds, ...)
                </legend>
                <div title="Quality Level"
                     class="slider" type="slider" gespref="geofs.preferences.graphics.quality"
                     update="{geofs.api.renderingQuality()}" value="3" min="1" max="6" precision="0">
                    <div class="slider-rail">
                        <div class="slider-selection">
                            <div class="slider-grippy">
                                <input class="slider-input"/>
                ...
                <div title="Color enhancement"
                     class="slider" type="slider" gespref="geofs.preferences.graphics.enhanceColors"
                     update="{geofs.api.enhanceColors(value)}" value="0" min="0" max="1.4" precision="1">
                    <div class="slider-rail">
                        <div class="slider-selection">
                            <div class="slider-grippy">
                                <input class="slider-input"/>
                ...
                <label class="mdl-switch mdl-js-switch mdl-js-ripple-effect geofs-hideForApp" for="simpleShadow" title="Force Simple Shadows">
                    <input type="checkbox" id="simpleShadow" class="mdl-switch__input" gespref="geofs.preferences.graphics.forceSimpleShadow"
                           update="{geofs.api.renderingQuality()}" />
                    <span class="mdl-switch__label">Force simple shadows (faster)</span>
                </label>
<!--
                <label class="mdl-switch mdl-js-switch mdl-js-ripple-effect geofs-hideForApp" for="waterEffect" title="Enable water effect">
                    <input type="checkbox" id="waterEffect" class="mdl-switch__input" gespref="geofs.preferences.graphics.waterEffect"
                           update="{geofs.api.setWaterEffect(this.checked)}">
                    <span class="mdl-switch__label">Enable water effect</span>
                </label>
-->
                <label class="mdl-switch mdl-js-switch mdl-js-ripple-effect .geofs-onlyForSubscribers" for="hdonoff" title="Enable HD images">
                    <input type="checkbox" id="hdonoff" class="mdl-switch__input" gespref="geofs.preferences.graphics.HD"
                           update="{if (geofs.preferences.graphics.HD==this.checked) geofs.api.setHD(this.checked)}">
                ...
                <label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="headMotion" title="Enable head acceleration motion">
                    <input type="checkbox" id="headMotion" class="mdl-switch__input" gespref="geofs.preferences.camera.headMotion">
...
<div class="geofs-trial-frame"><h5>Try HD, free, for a day!</h5><p>Before purchasing a subscription, try HD satellite images <b>free</b> for one-day.</p><div style="text-align: center;"><h6 class="geofs-notification geofs-info"><i class="material-icons">&#xE88E;</i> You need to be logged-in in order to start the one-day free trial</h6><a class="mdl-button mdl-js-button mdl-button--raised mdl-button--accent mdl-js-ripple-effect" href="#" disabled>Start free one-day HD trial</a></div></div>                </div>
        ...
        <div class="geofs-collapsible">
            ...
            <fieldset>
                <label class="mdl-switch mdl-js-switch mdl-js-ripple-effect" for="weatherManual" title="Set environment manually">
                    <input type="checkbox" id="weatherManual" class="mdl-switch__input" gespref="geofs.preferences.weather.manual"
            ...
            <fieldset class="geofs-manualWeather">
                ...
                <div title="Set time of day" class="slider geofs-timeSlider" type="slider"
                     gespref="geofs.preferences.weather.localTime" update="{weather.set()}" value="12" min="0"
                     max="24" precision="2">
                    <div class="slider-rail">
                        <div class="slider-selection">
                            <div class="slider-grippy">
            ...
            <fieldset class="geofs-manualWeather">
                ...
                <div title="Weather quality"
                     class="slider" type="slider" gespref="geofs.preferences.weather.quality"
                     update="{weather.setManual()}" value="0" min="0" max="100" precision="0">
                    <div class="slider-rail">
                        <div class="slider-selection">
                            <div class="slider-grippy">
                                <input class="slider-input"/>
                ...
                <div title="Season"
                     class="slider" type="slider" gespref="geofs.preferences.weather.season"
                     update="{weather.set()}" value="0" min="0" max="100" precision="0">
                    <div class="slider-rail">
                        <div class="slider-selection">
                            <div class="slider-grippy">
                                <input class="slider-input"/>
            ...
            <fieldset class="geofs-manualWeather geofs-advancedWeather">
                <legend>
                    Advanced
                </legend>

                <div title="Clouds" class="slider" type="slider" gespref="geofs.preferences.weather.advanced.clouds" update="{weather.setAdvanced()}" value="0" min="0" max="100" precision="0">
                ...
                <div title="CloudsCeiling" class="slider" type="slider" gespref="geofs.preferences.weather.advanced.ceiling" update="{weather.definition.ceiling = geofs.preferences.weather.advanced.ceiling; geofs.fx.cloudManager.instance.setCeiling()}" value="0" min="200" max="5000" precision="0">
                ...
                <div title="Precipitations" class="slider" type="slider" gespref="geofs.preferences.weather.advanced.precipitationAmount" update="{weather.setAdvanced()}" value="0" min="0" max="100" precision="0">
                ...
                <div title="Fog" class="slider" type="slider" gespref="geofs.preferences.weather.advanced.fog" update="{weather.setAdvanced()}" value="0" min="0" max="100" precision="0">
                ...
                <div title="FogCeiling" class="slider" type="slider" gespref="geofs.preferences.weather.advanced.fogCeiling" update="{weather.setAdvanced()}" value="0" min="0" max="3000" precision="0">
                ...
                <div title="windSpeed" class="slider" type="slider" gespref="geofs.preferences.weather.advanced.windSpeedMS" update="{weather.setAdvanced()}" value="0" min="0" max="20" precision="0">
                ...
                <div title="windDirection" class="slider" type="slider" gespref="geofs.preferences.weather.advanced.windDirection" update="{weather.setAdvanced()}" value="0" min="0" max="360" precision="0">
                ...
                <div title="turbulences" class="slider" type="slider" gespref="geofs.preferences.weather.advanced.turbulences" update="{weather.setAdvanced()}" value="0" min="0" max="1" precision="1">
    ...
    <li class="geofs-list-collapsible-item geofs-collapsible-profile geofs-onlyForApp">User account
        <div class="geofs-collapsible geofs-htmlView geofs-app-userProfile geofs-account-placeholder"></div>
    </li>

    <li class="geofs-list-collapsible-item">Instructions
        <div class="geofs-collapsible">
                    </div>
    </li>
    <li class="geofs-list-collapsible-item geofs-onlyForApp">Credits/Attributions
        <div class="geofs-collapsible">
            <br/>
            <img src="images/bing.png"/><br/>
            <br/><br/>
            HD images are provided by Microsoft Bing Maps<br/>
            <br/>
            SD images come from <i><a class="a-light" xmlns:dct="http://purl.org/dc/terms/" href="https://s2maps.eu" property="dct:title">Sentinel-2 cloudless - https://s2maps.eu</a> by <a class="a-light" xmlns:cc="http://creativecommons.org/ns#" href="https://eox.at" property="cc:attributionName" rel="cc:attributionURL">EOX IT Services GmbH</a> (Contains modified Copernicus Sentinel data 2016 &amp; 2017)</i><br/>
            <br/>
            GeoFS uses Cesium (<a href="https://cesium.com">https://cesium.com</a>) for rendering.<br/>
            <br/>
            For more information about credits and attribution for GeoFS, please visit <a href="https://www.geo-fs.com">https://www.geo-fs.com</a>
        </div>
    </li>
    <li class="geofs-list-collapsible-item geofs-hideForApp">Debug info
        <div class="geofs-collapsible geofs-tab-debug">
            ...
            <br/><br/>
            <textarea class="geofs-debug-info"></textarea>
        </div>
    </li>
    <li class="geofs-list-collapsible-item geofs-onlyForApp">Reset settings
        <div class="geofs-collapsible geofs-tab-debug">
            In case of recurring error, please try to reset saved settings to default:<br/>
            <button class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" onclick="geofs.resetPreferences();">Reset Settings</button>
        </div>
    </li>
    <!-- Bottom buttons -->
    <div class="geofs-preferenceForm geofs-hideForApp">
        <div style="float: left;">
            <button class="mdl-button mdl-js-button mdl-button--raised mdl-button--colored" onclick="geofs.resetPreferences();">Reset Settings</button>
        </div>
        <div style="float: right;">
            <button class="mdl-button mdl-js-button mdl-button--raised mdl-button--accent" onclick="geofs.savePreferencesPanel(); ui.closePreferencePanel();">Close</button>
        </div>
    </div>
</ul>
...
<script type="text/javascript">
    ...
    for (var i in geofs.aircraftList) {
        geofs.aircraftList[i].path = geofs.aircraftList[i].dir.replace(/\|/gi, '/');
...
</script><ul class="geofs-list geofs-toggle-panel geofs-player-list geofs-authenticated" onshow="{ui.initPlayerList()}" onhide="{ui.clearPlayerList()}"></ul><!-- Navigation panel --><div class="geofs-map-list geofs-toggle-panel" onshow="{ui.createMap()}" onhide="{ui.stopMap()}" data-noblur="true">
            ...
            <div class="geofs-autopilot geofs-stopKeyboardPropagation geofs-stopMousePropagation">
                <h6>Autopilot</h6>
                <button class="mdl-button mdl-js-button mdl-button--raised geofs-autopilot-toggle" onclick="controls.autopilot.toggle();" title="Toggle autopilot on/off - [A]">Disengaged</button>
                <div class="geofs-autopilot-displays">
                    <label>
                        Altitude
                        <input type="number" placeholder="00000" min="0" step="1000" class="geofs-autopilot-altitude" onchange="controls.autopilot.setAltitude(this.value);"><span>Ft.</span>
                    </label>
                    <label>
                        Heading
                        <input type="number" placeholder="000" min="0" max="359" step="1" class="geofs-autopilot-heading" onchange="controls.autopilot.setHeading(this.value);"><span>Deg.</span>
                    </label>
                    <label>
                        Speed
                        <input type="number" placeholder="0" min="0" step="10" class="geofs-autopilot-kias" onchange="controls.autopilot.setKias(this.value);"><span>Kts.</span>
                    </label>
                </div>
            </div>
        ...
        <!-- Debug panel -->
        <div class="geofs-debug geofs-toggle-panel" onshow="{geofs.debug.turnOn()}" onhide="{geofs.debug.turnOff()}" data-noblur="true">
            <div class="geofs-debugFrame">
                ...
                <button class="btn" onclick="geofs.aircraft.instance.change(geofs.aircraft.instance.name, /* justReload */ true);">Just Reload</button>
                <button class="btn" onclick="geofs.aircraft.instance.change(geofs.aircraft.instance.name, /* justReload */ true); instruments.init(geofs.aircraft.instance.setup['instruments']); instruments.updateCockpitPositions();">Reload - Instru</button>
                -------------------------------------
                <label>Multiplayer Id<input type="text" class="debugAicraftId"></label>
                <p class="debugMultiplayerData"></p>
    ...
    <div class="geofs-ui-right">
        ...
        <div class="geofs-ui-top">
            ...
            <script>geofs.userRecord={"sessionId":"hs433v95h1toskgk7am7kcube6","role":0};</script>
...
<div class="geofs-auth geofs-htmlView">
                ...
                <img src="/images/facebook-login.png" class="geofs-facebook-login" />
                ...
                <div class="geofs-google-signin google-signin" id="google-signin1"></div>
            </div>
      <script>window.executeOnEventDone('afterDeferredload', function() {Cesium.Ion.defaultAccessToken = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJqdGkiOiIwYjk1N2FhZi1hN2M5LTQ4ZmUtOWVhMS0yNDVjODBmODlmOGQiLCJpZCI6NzYsImlhdCI6MTQ4ODIxMDc4OX0.Sv58Vigu_z-rEXj1SyO1ygvo4LhA6bDPyKIjsQ3Bgc4';});</script>
<script>document.body.classList.remove('geofs-subscribed')</script>
<script>geofsNewHDState = false;</script>
<script>geofs.geoIpUpdate = function() {jQuery('.geofs-creditContainer').html('<a rel="nofollow" target="_blank" href="https://s2maps.eu">Sentinel-2 cloudless - https://s2maps.eu</a> by <a rel="nofollow" target="_blank" href="https://eox.at/">EOX IT Services GmbH</a> (Contains modified Copernicus Sentinel data 2016 & 2017)');geofs.preferences.graphics.HD = false; document.body.classList.remove('geofs-hd'); geofs.api.imageryProvider = Cesium.createTileMapServiceImageryProvider({url: 'https://data3.geo-fs.com/sent/',fileExtension: 'jpg',tilingScheme: new Cesium.GeographicTilingScheme({numberOfLevelZeroTilesX:2, numberOfLevelZeroTilesY:1}),maximumLevel: 13,}); geofs.api.setImageryProvider(geofs.api.imageryProvider, true, 1.5, 1.2, 1); geofs.api.viewer.terrainProvider = geofs.api.flatRunwayTerrainProviderInstance = new geofs.api.FlatRunwayTerrainProvider({baseProvider: new Cesium.CesiumTerrainProvider({url: 'https://data3.geo-fs.com/srtm/',requestWaterMask: false, requestVertexNormals:false}),bypass: false,maximumLevel: 12});geofs.api.analytics.event('geofs', 'mode', 'sd', 1);};</script>
<script>window.executeOnEventDone('afterDeferredload', function() {if(geofs.api.hdOn === geofsNewHDState) return; geofs.geoIpUpdate(); geofs.api.hdOn = geofsNewHDState; geofs.api.renderingQuality(); jQuery('body').trigger('terrainProviderUpdate');});</script>
<script>window.executeOnEventDone('afterDeferredload', function() {geofs.savePreferences();});</script>
<script>window.executeOnEventDone('afterDeferredload', function() {geofs.mapXYZ = 'https://data3.geo-fs.com/osm/{z}/{x}/{y}.png';});</script>

</div><a href="/" class="geofs-home-button" title="GeoFS home page">
            ...
            <div class="geofs-autopilot-bar" style="left: 130px;">
                ...
                <div class="geofs-autopilot-controls">
                    <div class="geofs-autopilot-control">
                        <a class="numberDown">-</a><div class="numberValue geofs-autopilot-kias" min="0" step="10" method="setKias">0</div><a class="numberUp">+</a>
                        <span>IAS</span>
                    </div>
                    <div class="geofs-autopilot-control">
                        <a class="numberDown">-</a><div class="numberValue geofs-autopilot-heading" min="0" max="359" loop="true" step="1" method="setHeading">000</div><a class="numberUp">+</a>
                        <span>HDG</span>
                    </div>
                    <div class="geofs-autopilot-control">
                        <a class="numberDown">-</a><div class="numberValue geofs-autopilot-altitude" min="0" step="1000" method="setAltitude">00000</div><a class="numberUp">+</a>
                        <span>ALTITUDE</span>
                    </div>
                    <div class="geofs-autopilot-control" style="display: none;">
                        <a class="numberDown">-</a><div class="numberValue geofs-autopilot-climbrate" min="-10000" step="500" method="setClimbrate">00000</div><a class="numberUp">+</a>
        ...
        <div class="geofs-canvas-mouse-overlay">
            ...
            <img src="/images/hd-logo.png" class="geofs-hd-logo"><!-- Instrument container --><div class="geofs-overlay-container"></div>
    ...
    <a href="/pages/hd.php" target="_top" style="display: inline-block; text-align: center; width: 100%;">
<img src="/images/ba/hd-skyscraper.jpg" style="width: 160px;"/></a></div>
<div class="geofs-refreshTarget">
            <script async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></script>
            <!-- GeoFS in game Responsive Banner -->
            <ins class="adsbygoogle"
                 style="display:block; width: 160px;"
                 data-ad-client="ca-pub-1808592532341984"
                 data-ad-slot="5302287636"
            ...
            window.executeOnEventDone('afterDeferredload', function() {
                ...
                $(document).on('flyto', function() {
                    ...
                    if (t - geofs.lastFlyTo > 40000) {
                        ...
                        if (geofs.adCount % 3 == 0) { // every three impressions
                            $('.geofs-refreshTarget').htmlView('load', '/pages/common/includes/ba/loader.php?type=2');
                        }
                        else {
		       	    $('.geofs-refreshTarget').empty().html('<scr'+'ipt async src="//pagead2.googlesyndication.com/pagead/js/adsbygoogle.js"></scr'+'ipt><ins class="adsbygoogle" style="display:block; width: 160px;" data-ad-client="ca-pub-1808592532341984" data-ad-slot="5302287636" data-ad-format="auto"></ins><scr'+'ipt>(adsbygoogle = window.adsbygoogle || []).push({});</scr'+'ipt>');
                        }
                        geofs.adCount++;
                        geofs.lastFlyTo = t;
                    }
...
--><li class="mdl-menu__item">
                ...
                <div class="geofs-ui-bottom-box geofs-f-standard-ui">
                    <button class="geofs-button-pause mdl-button mdl-js-button mdl-button--icon" onclick="geofs.togglePause();" title="Pause/Unpause the simulation [P]"><i class="material-icons">pause_circle_outline</i></button>
            ...
            <li class="mdl-menu__item">
                <button class="mdl-button mdl-js-button geofs-f-standard-ui" data-toggle-panel=".geofs-map-list" title="Navigation and Autopilot panel [N]"><i class="material-icons">explore</i> Nav</button>
            </li>
        ...
        </ul><!-- Options and map --><div class="geofs-ui-bottom-separator geofs-f-standard-ui geofs-bigScreenOnly"></div>
        <button class="mdl-button mdl-js-button geofs-f-standard-ui" data-toggle-panel=".geofs-preference-list" title="Open the settings/options panel [O]" data-tooltip-classname="mdl-tooltip--top">Options <i class="material-icons geofs-ui-bottom-icon">settings</i></button>
        ...
        <div class="geofs-ui-bottom-box geofs-f-standard-ui geofs-bigScreenOnly">
            <button class="geofs-button-pause mdl-button mdl-js-button mdl-button--icon" data-tooltip-classname="mdl-tooltip--top" onclick="geofs.togglePause();" title="Pause/Unpause the simulation [P]"><i class="material-icons">pause_circle_outline</i></button>
        ...
        <div class="geofs-f-recordPlayer geofs-bigScreenOnly">
            ...
            <div class="geofs-ui-bottom-box">
                <button class="mdl-button mdl-js-button mdl-button--icon" onclick="flight.recorder.setStep(0);" data-tooltip-classname="mdl-tooltip--top" title="Begining"><i class="material-icons">fast_rewind</i></button>
                ...
                <button class="mdl-button mdl-js-button mdl-button--icon" onclick="flight.recorder.setStep(100000);" data-tooltip-classname="mdl-tooltip--top" title="End"><i class="material-icons">fast_forward</i></button>
            </div>
    ...
    <div class="mdl-dialog geofs-user-block">

        <div class="geofs-chat-user-popup">
            Pilot: <b class="geofs-user-callsign"></b>
            <button class="geofs-cancel btn">Cancel</button>
            <button class="geofs-ignore-user btn btn-inverse"><i class="icon-ban-circle icon-white"></i> Block</button>

        </div>

        <h4 class="mdl-dialog__title">Pilot <b class="geofs-user-callsign"></b></h4>
        <div class="mdl-dialog__content">
            <p>
                Would you like to stop receiving messages from user <b class="geofs-user-callsign"></b>?
            </p>
            </div>
        <div class="mdl-dialog__actions">
            <button class="geofs-ignore-user mdl-button mdl-button--raised mdl-button--colored">Block user</button>
            <button class="mdl-button close geofs-cancel">Cancel</button>
        </div>
    </div>
</body></html>
