...
import {DEGREES_TO_RAD,RAD_TO_DEGREES,PI,TWO_PI
    ,HALF_PI,AXIS_TO_INDEX,DEFAULT_AIRFOIL_ASPECT_RATIO,AXIS_TO_VECTOR}from "./utils"
...
aircraft.Aircraft.prototype.addShadow = function() {
    this.removeShadow();
...
aircraft.Aircraft.prototype.loadDefault = a => {
...
aircraft.Aircraft.prototype.init = function(a, b, c) {
    this.setup = a;
    this.controllers = {
        pitch: {
            recenter: !1,
...
aircraft.Aircraft.prototype.loadCockpit = function() {
