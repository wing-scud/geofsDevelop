...
Object3D.prototype = {
  ...
  compute(a) {
    ...
    b = this._collisionPoints;
    c = 0;
    for (let d = b.length; c < d; c++) { this.setVectorWorldPosition(b[c]); }
    !this._nodeName && (c = this._scaleOffset ? V3.scale(this.worldPosition, this._scaleOffset) : this.worldPosition,
