...
camera.translate = function (a) {
  ...
  camera.zoomDistance < -geofs.aircraft.instance.setup.cameras.follow.distance + 5 && (camera.zoomDistance = -geofs.aircraft.instance.setup.cameras.follow.distance + 5),
  !0) : !1;
}
;
...
camera.setRotation = function (a, b) {
  ...
  !0) : camera.currentModeName == 'cockpit' ? (a = fixAngle(a + 180),
